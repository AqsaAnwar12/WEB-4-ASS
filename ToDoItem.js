  ...
  return (
    <div className="task-item" style={{ marginBottom: "10px" }}>
      ...
      {isEditing ? (
        ...
        <>
          <button onClick={handleToggleEdit} style={{ marginLeft: '10px', color: 'gray' , backgroundColor: 'light-green'}}>
            Edit
          </button>
          <button onClick={() => deleteTask(item.id)} style={{ marginLeft: '10px' , color: 'black' }}>
            Delete
          </button>
        </>
      )}
